...
public class JravatarTest {
	...
	public void testGetImageUrlRating() {
		jravatar.withRating(GravatarRating.PARENTAL_GUIDANCE_SUGGESTED);
	...
	public void testGetImageUrlCombined() {
		jravatar.withSize(123).withRating(GravatarRating.PARENTAL_GUIDANCE_SUGGESTED).withDefaultImage(GravatarDefaultImage.IDENTICON);
